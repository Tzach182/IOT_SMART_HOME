...
button_topic = 'healthUpdate/person/id/status'
...
class ConnectionDock(QDockWidget):
    ...
    def push_button_click(self):
        message = {"type" : "2", "message": "Doctor has been notified about your condition"}
        message_as_json = json.dumps(message)
        self.mc.publish_to(button_topic, message_as_json)
...
class MainWindow(QMainWindow):
    ...
    def __init__(self, parent=None):
        ...
        self.setWindowTitle('Panic Button')
